        ...
        <form id="contact-form" novalidate>
          ...
          <div class="form-row">
            ...
            <div class="form-field"><label for="oggetto">I'm interested in <span class="req">*</span></label>
              <select id="oggetto" name="oggetto" required><option value="">Select…</option><option>Turnkey project</option><option>Glamping bubbles</option><option>Bubbles for bars &amp; restaurants</option><option>Other</option></select>
